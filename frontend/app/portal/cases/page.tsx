...
function CasesContent() {
  ...
  const VirtuosoTableComponents = {
    ...
    Table: (props: React.HTMLAttributes<HTMLTableElement>) => <table {...props} style={{ borderCollapse: 'collapse', width: '100%' }} />,
    TableHead: React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>((props, ref) => <thead {...props} ref={ref} />),
    TableRow: (props: React.HTMLAttributes<HTMLTableRowElement>) => <tr {...props} style={{ borderBottom: '1px solid #e0e0e0' }} />,
